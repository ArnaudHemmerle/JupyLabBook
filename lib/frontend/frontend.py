...
-Modify the function Choose_treatment() to add your custom functions.
"""
...
def Check_files(expt):
    ...
    Create_cell(code='FE.Choose_action(expt)', position ='at_bottom', celltype='code', is_print=False)   
...
def Choose_action(expt):
    ...
    def on_button_treat_clicked(b):
        ...
        Create_cell(code='FE.Choose_treatment(expt)',
    ...
    def on_button_form_clicked(b):
        ...
        """
        #clear_output(wait=False)
        Create_cell(code='FE.Create_form()',position ='below', celltype='code', is_print=False)
        Create_cell(code='FE.Choose_action(expt)', position ='at_bottom', celltype='code', is_print=False)        
